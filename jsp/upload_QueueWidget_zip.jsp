            ...
            $("#uploader").pluploadQueue({
                ...
                init: {
                    ...
                    FileUploaded: function (up, file, info) {
                        ...
                        //alert("FileUploaded 完了 11111111");
                        
                        var obj = jQuery.parseJSON(result);
                        //alert(obj.jsondata[0].fileUrl);
                       
                        //var txt = "";
                        for(var i = 0 ; i < obj.jsondata.length ; i++) {

                            var fileUrlTxt = obj.jsondata[i].fileUrl;
                            var fileNameTxt = obj.jsondata[i].fileName;
                           // alert(fileUrlTxt);
