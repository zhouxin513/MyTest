...
<b>
<s:text name="HCSCCOMZ15001.pageName" />
</b>
</div>
...
<s:textfield id="userid" name="form.mailAddress" maxlength="55" cssClass="showInput" onfocus="hideText(1)" onblur="showText(1)">
</s:textfield>
</div>
</div>
<!-- パスワード -->
...
<s:password id="idpassword" name="form.password" maxlength="16" cssClass="showInput" onfocus="hideText(2)" onblur="showText(2)">
</s:password>
</div>
</div>
</center>
...
<s:checkbox name="form.loginRetainFlag">
</s:checkbox>
